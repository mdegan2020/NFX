classdef (Sealed) FCRNSA < nfx.TRE
    %FCRNSA - Supplied WGS 84 corner coordinates
    %   OBJ = FCRNSA(Name=VALUE) sets PREDICT_CORNERS and the latitude,
    ...
    methods
        ...
        function report = validate(obj) %#codegen
            ...
            report = newReport('STDI-0002 Appendix AW FCRNSA');
            reference = 'STDI-0002-1 Appendix AW, Tables AW.6-1 and AW.6-2';
            report = addIssue(report, ~any(strcmp(obj.predict_corners, cellstr('YNIJ'.'))), ...
