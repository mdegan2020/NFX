...
[Additional TRE support](TRE_SUPPORT.md) covers GEOPSB, BNDPLC, XMLDCA,
SECURA envelopes, PIXQLA, CSCCGA, MSTGTA, BLOCKA and ENGRDA. It also adds
NODISPLY pixel-quality masks and binary/percentage cloud-cover grids.
